...
namespace NinetiesTV
{
    class Program
    {
        ...
        **************************************************************************************************/
        ...
        static List<Show> NamesAlphabetically(List<Show> shows)
        {
           return shows.OrderBy(shows => shows.Name).ToList();
        }
        ...
        {
            List<Show> NinetiesShows = shows.Where(shows => shows.StartYear >= 1990 && shows.EndYear < 2000 == true).ToList();
            return NinetiesShows;
        }
